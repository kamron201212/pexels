...
function createPhotoCard(photo) {
  ...
  photoCard.innerHTML = `
    ...
    <div class="absolute inset-0 flex flex-col justify-between items-stretch p-2 z-30 pointer-events-none">
      ...
      <div class="dropdown-wrapper group/dropdown relative self-end group-hover:backdrop-blur-lg rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-out pointer-events-auto truncate translate-x-4 group-hover:translate-x-0 transition-transform delay-150">
